...
const double N_A = 2e17;				  //concentration of singly ionized acceptors
const double N_D = 2e17;				  //concentration of donor concentration
...
const double epsilon = 2.656256346e-11;		//eps_active * epsilon_0
//Thicknesses (in m)
...
const double tolerance_eq = 100*5e-8;        //error tolerance for equil run£¨Ô­±¾ÊÇ100*5e-12)
